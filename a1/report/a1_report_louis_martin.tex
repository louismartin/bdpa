...
\begin{itemize}
  ...
  \lstinputlisting[firstnumber=52, firstline=52, lastline=84, language=java]{assets/InvertedIndex.java}
  ...
  \lstinputlisting[firstnumber=87, firstline=87, lastline=116, language=java]{assets/InvertedIndex.java}
  ...
  \lstinputlisting[firstnumber=124, firstline=124, lastline=147, language=java]{assets/InvertedIndex.java}
\end{itemize}
...
\lstinputlisting[firstnumber=31, firstline=31, lastline=33, language=java]{assets/InvertedIndex.java}
Which is incremented in the reducer's reduce function:
\lstinputlisting[firstnumber=160, firstline=160, lastline=166, language=java]{assets/InvertedIndex.java}
...
\lstinputlisting[firstnumber=220, firstline=220, lastline=227, language=java]{assets/InvertedIndex.java}
...
\begin{itemize}
  ...
  \lstinputlisting[firstnumber=36, firstline=36, lastline=49, language=java]{assets/InvertedIndex.java}
  \item \textbf{Combiner:}\\
  ...
  \lstinputlisting[firstnumber=119, firstline=119, lastline=147, language=java]{assets/InvertedIndex.java}
  \item \textbf{Reducer:}\\
  ...
  \lstinputlisting[firstnumber=150, firstline=150, lastline=168, language=java]{assets/InvertedIndex.java}
\end{itemize}
